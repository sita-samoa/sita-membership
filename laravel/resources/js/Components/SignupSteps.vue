...
const form = useForm({
  ...
  membership_application_status_id:
    props.member.membership_application_status_id ?? "",
});
      ...
      <tabs v-model="activeTab" class="p-5">
          ...
          <form @submit.prevent="submit">
            ...
            <div class="mb-4">
              <div
                ...
                v-for="m in props.options.membership_type_options"
              >
                <input
                  :id="m.id"
                  type="radio"
            ...
            <!-- next button -->
            <Button
              v-show="props.permissions.canUpdate"
              type="submit"
              class="p-3 mt-3"
              >Next</Button
            >
        ...
        <tab name="second" title="General" :disabled="disableTabs">
          <form @submit.prevent="submit">
            ...
            >
              ...
              <option v-for="t in props.options.title_options" :value="t.id">
                {{ t.title }}
              </option>
            </select>
            ...
            <div
              ...
              v-for="g in props.options.gender_options"
            >
              <input
                :id="g.id"
                type="radio"
        ...
        <tab name="fifth" title="Memberships" :disabled="disableTabs">
          <form @submit.prevent="submit">
            ...
            <textarea
              id="message"
              v-model="form.other_membership"
              rows="4"
              class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="List each professional organisation you are a member of in a separate line..."
            ></textarea>
        ...
        <tab name="sixth" title="Qualifications" :disabled="disableTabs">
          <MemberQualifications
            :member_id="member_id"
            :list="props.qualifications"
            :editable="props.permissions.canUpdate"
          />
          <MemberDocuments
            :member_id="member_id"
            :list="props.supportingDocuments"
          />
        ...
        <tab name="ninth" title="Mailing Lists" :disabled="disableTabs">
          <div>
            ...
            <Alert type="info" class="mt-3 mb-2"
              >Please check the mail lists you want to join.
            </Alert>

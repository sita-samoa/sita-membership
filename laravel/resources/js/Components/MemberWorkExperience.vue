...
<template>
  <div>
    ...
    <div
      v-if="memberWorkExperiences ? memberWorkExperiences.length : false"
      class="relative mt-3 overflow-x-auto shadow-md sm:rounded-lg"
    >
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              {{ workExperience.from_date }} to {{ workExperience.to_date }}
            </td>
          </tr>
        </tbody>
      </table>
  ...
  <DialogModal :show="isShowModal" @close="closeModal">
    <template #title>
      <div v-if="!form.id" class="flex items-center text-lg">
        Add Work Experience
      </div>
    ...
    <template #content>
      ...
      <Alert type="info" class="mt-3 mb-2"
        >Please provide only a brief summary of roles and responsibilities.
      </Alert>
      <InputLabel
        for="message"

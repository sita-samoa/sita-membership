...
<template>
  <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    ...
    <the-card
      :ref="route('members.signup.index', props.member.id)"
      class="mb-3"
    >
      <h5
        class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"
      >
        <span v-if="props.member.title_id">{{ props.member.title.title }}</span>
        {{ member_name }}
      </h5>

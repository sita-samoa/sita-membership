...
<template>
  ...
  <component :is="is" v-else ref="root" class="block lg:flex items-center relative cursor-pointer" :class="componentClass" :href="itemHref" :target="item.target ?? null" @click="menuClick">
    <div
    ...
    >
      ...
      <BaseIcon v-if="item.menu" :path="isDropdownActive ? mdiChevronUp : mdiChevronDown" class="hidden lg:inline-flex transition-colors" />
    </div>

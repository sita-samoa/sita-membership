...
defineProps(['member', 'options', 'data', 'statuses', 'membershipStatuses'])
</script>
...
<template>
  <LayoutAuthenticated title="Summary">
    <SectionMain>
      ...
      <SignupSummary :member="member" :options="options" :data="data" :statuses="statuses" :membershipStatuses="membershipStatuses" />
    </SectionMain>
  </LayoutAuthenticated>
</template>

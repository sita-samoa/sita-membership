...
1. **Build system**: [Vite](https://vitejs.dev/) (`^8.0.16`)
...
7. **Testing framework**: _Not explicitly listed in package.json_ (none detected)
8. **Other major dependencies**:
   - [Axios](https://axios-http.com/) (`^1.13.2`)
...
1. **Main framework**: [Laravel](https://laravel.com/) (`^12.0`)
2. **Programming language**: PHP (`^8.2`)
3. **API & HTTP**: [GuzzleHTTP](https://docs.guzzlephp.org/) (`^7.2`), [Inertia.js Laravel](https://inertiajs.com/server-side-setup) (`^2.0`)
4. **Authentication & Security**: [Laravel Jetstream](https://jetstream.laravel.com/) (`^5.0`), [Laravel Sanctum](https://laravel.com/docs/sanctum) (`^4.0`)
5. **Database & Data**:
   - [Maatwebsite Excel](https://docs.laravel-excel.com/) (`^3.1`)
   - [Laraveldaily Invoices](https://laraveldaily.com/package/laravel-invoices/) (`^4.0`)
   - [Monarobase Country List](https://github.com/Monarobase/country-list) (`^3.4`)
   - [OwenIt Laravel Auditing](https://github.com/owen-it/laravel-auditing) (`^14.0`)
6. **Monitoring & Error Reporting**: [Sentry Laravel](https://docs.sentry.io/platforms/php/guides/laravel/) (`^4.6`)
7. **Backup & Utilities**: [Spatie Laravel Backup](https://spatie.be/docs/laravel-backup) (`^9.2`), [TightenCo Ziggy](https://github.com/tighten/ziggy) (`^1.0`)
8. **Development tools**:
   - [Laravel Sail](https://laravel.com/docs/sail) (`^1.18`)
   - [Laravel Pint](https://laravel.com/docs/pint) (`^1.0`)
   - [PHP_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) (`^3.7`)
   - [Rector](https://github.com/rectorphp/rector) (`^2.0`), [Rector Laravel](https://github.com/driftingly/rector-laravel) (`^2.0`)
   - [FakerPHP Faker](https://fakerphp.github.io/) (`^1.9.1`)
   - [Mockery](https://github.com/mockery/mockery) (`^1.4.4`)
   - [Nunomaduro Collision](https://github.com/nunomaduro/collision) (`^8.1`)
   - [Spatie Laravel Ignition](https://spatie.be/docs/laravel-ignition) (`^2.0`)
9. **Testing framework**: [PestPHP](https://pestphp.com/) (`^3.0`), [PestPHP Laravel Plugin](https://pestphp.com/docs/laravel) (`^3.0`)
